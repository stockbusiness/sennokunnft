...
const USER_MESSAGES: Readonly<Record<DomainErrorCode, string>> = {
  ...
  */
  ...
  /*
    ⚠️ **「結果が出てから」と書かない**（決定 B・2026-08-22）。争いは待っても
       開かない。下書きを作り直せばそのご注文が外れ、残りは今回お支払い
       できる。**やることは「待つ」ではなく「作り直す」**である。
  */
  PAYOUT_DISPUTE_OPEN:
    '下書きを作ったあとに、カード会社との間で争いになったご注文があります。下書きを作り直してください。そのご注文は今回のお支払いから外れ、決着後の精算に含まれます。',
